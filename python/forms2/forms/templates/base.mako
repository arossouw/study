...
<head>
  ...
  <link rel="shortcut icon" href="${request.static_url('forms:static/foundation/favicon.ico')}" />

  <title>Basic Forms</title>

  <link rel="stylesheet" href="${request.static_url('forms:static/foundation/css/normalize.css')}">
  <link rel="stylesheet" href="${request.static_url('forms:static/foundation/css/foundation.css')}">
  <link rel="stylesheet" href="${request.static_url('forms:static/css/base.css')}">
  <link rel="stylesheet" href="${request.static_url('forms:static/css/monokai.css')}">

  <script src="${request.static_url('forms:static/foundation/js/vendor/custom.modernizr.js')}"></script>
...
-->
  ...
  <script src="${request.static_url('forms:static/foundation/js/vendor/zepto.js')}"></script>
  <script src="${request.static_url('forms:static/foundation/js/foundation.min.js')}"></script>
  <script>
    $(document).foundation();
  </script>
</body>
